...
printf("Size of char: %ld byte\n", sizeof(charType));//sizeof함수를 통해 charType 변수의 자료형이 가						진 메모리 크기를 출력
printf("Size of int: %ld bytes\n", sizeof(integerType));//sizeof함수를 통해 integerType 변수의 자료형						  이 가진 메모리 크기를 출력
...
printf("Size of double: %ld bytes\n", sizeof(double));//sizeof함수를 통해 double형 자료형이 가진 메모						리 크기 출력
printf("-----------------------------------------\n");
printf("Size of char*: %ld byte\n", sizeof(char*));//sizeof함수를 통해 char형 포인터가 가진 메모리 크					      기 출력
printf("Size of int*: %ld bytes\n", sizeof(int*));//sizeof함수를 통해 int형 포인터가 가진 메모리 크기 출					    력
printf("Size of float*: %ld bytes\n", sizeof(float*));//sizeof함수를 통해 float형 포인터가 가진 메모리 크					       기 출력
printf("Size of double*: %ld bytes\n", sizeof(double*));//sizeof함수를 통해 double형 포인터가 가진 메						   모리 크기 출력
return 0;
}
